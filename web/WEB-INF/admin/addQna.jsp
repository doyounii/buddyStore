            ...
            <div class="box_wrap">
                <form action="${path }/AddQnaPro.do" method="post">
                    <table class="table table-secondary" id="tb1">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="title" id="title" class="form-control">
                                <input type="hidden" name="lev" id="lev" value="${qna.lev }">
                                <input type="hidden" name="par" id="par" value="${qna.par }">
                                <input type="hidden" name="author" id="author" value="${qna.sid }"></td>
                        </tr>
                        <tr>
                            <c:if test="${lev == 0}">
                                <th>QNA 내용</th>
                    ...
                    <div class="group container">
                        ...
                        <a href="${path }/NoticeList.do" class="btn btn-primary">QNA 목록</a>
                    </div>
                </form>
            </div>
        </div>
